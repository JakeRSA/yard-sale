...
import { Card, CardHeader, CardMedia, CardContent, CardActions, Avatar, IconButton, Typography, SxProps,  } from '@mui/material'
import { Favorite, Share, MoreVert, Comment } from '@mui/icons-material'
import SwiperCore, {
    Keyboard,
    Scrollbar,
    Pagination,
